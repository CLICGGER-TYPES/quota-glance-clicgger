...
export const simplifiedChineseMessages = {
  ...
  'prefs.panel.side.title': '顶栏位置',
  'prefs.panel.side.subtitle': 'GNOME 顶栏的左侧 / 中间 / 右侧',
  'prefs.panel.side.left': '左侧',
  'prefs.panel.side.center': '中间',
  'prefs.panel.side.right': '右侧',
  'prefs.panel.top': 'GNOME 顶部面板',
  'prefs.panel.bottom': 'Dash to Panel 底部面板',
  'prefs.proxy.title': '代理',
  'prefs.proxy.description': '用于渠道请求和命令行渠道（Codex）。留空则沿用环境变量里的代理',
  'prefs.proxy.url.title': '代理地址（http://主机:端口）',
  'prefs.proxy.noProxy.title': '不走代理的地址',

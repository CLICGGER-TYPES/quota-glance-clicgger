export const englishMessages = {
  ...
  'prefs.panel.side.title': 'Top bar position',
  'prefs.panel.side.subtitle': 'Left, center or right of the GNOME top bar',
  'prefs.panel.side.left': 'Left',
  'prefs.panel.side.center': 'Center',
